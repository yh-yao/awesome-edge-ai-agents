...
|-----------------------------|-----------------------------|-------------------------------------------------------------------------------------------------|------|
| **MLPerf Tiny**             | Embedded / TinyML           | Industry-standard inference benchmark suite for ultra-low-power embedded devices (microcontrollers); covers tasks like keyword spotting, visual wake words, image classification, anomaly detection. Measures accuracy, latency, and energy. :contentReference[oaicite:0]{index=0} | [MLPerf Tiny](https://mlcommons.org/benchmarks/inference-tiny/) |
...
| **AndroidWorld**            | UI Agent / Autonomous       | Dynamic benchmarking environment for autonomous agents controlling Android UIs. Contains 116 programmatically generated tasks across 20 apps; supports reproducible evaluation and robustness testing. :contentReference[oaicite:1]{index=1} | [AndroidWorld (GitHub)](https://github.com/google-research/android_world) |
...
| **AIoTBench**               | Mobile / Embedded (Legacy)  | Older mobile/embedded benchmark suite evaluating inference speed across mobile frameworks (TensorFlow Lite, Caffe2, PyTorch Mobile). Introduces metrics like VIPS and VOPS. :contentReference[oaicite:2]{index=2} | [AIoTBench (arXiv)](https://arxiv.org/abs/2005.05085) |
